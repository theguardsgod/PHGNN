...
class LoaderHelper:
    ...
    def __init__(self, task: Task = Task.NC_v_AD):
        ...
        #cat12
        # self.train_ds = MRIDataset(root_dir="/home/ubuntu22/dataset/adni/adni1/",
        #         labels=self.labels,
        #         training=True,
        #         transform=transforms.Compose([
        #         ToTensor()
        #     ]))
        # self.test_ds = MRIDataset(root_dir="/home/ubuntu22/dataset/adni/adni2/",
        #         labels=self.labels,
        #         training=False,
        #         transform=transforms.Compose([
        #         ToTensor()
    ...
    def get_train_dl(self, fold_ind, shuffle=True, batch_size = 16):

        
        train_ds = Subset(self.train_ds, self.indices[0])
        train_dl = DataLoader(train_ds, batch_size=batch_size, shuffle=shuffle, num_workers=4, drop_last=True)
